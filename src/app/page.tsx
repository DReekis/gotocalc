        ...
        <section>
          ...
          <div className={styles.categoryGrid}>
            ...
            <div className={styles.categoryCard}>
              ...
              <p className={styles.categoryText}>Percentage increase, decrease, and ratio finder, plus a full-featured scientific calculator with trig, logarithms, powers, and factorials.</p>
            </div>
