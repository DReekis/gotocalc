...
const GstCalculatorForm = dynamic(
  () => import("@/components/calculators/GstCalculatorForm"),
      ...
      <CalculatorShell
        ...
        definitionContent={
          <>
            <p>
              ...
              levied on the supply of goods and services in India, replacing
              multiple cascading taxes like VAT, Service Tax, and Excise Duty.
              Implemented on July 1, 2017, GST follows a destination-based
              taxation model.
            </p>
            <p>
              GST is divided into <strong>CGST</strong> (Central GST — collected
              by the Central Government),
              <strong> SGST</strong> (State GST — collected by the State
              Government) for intra-state transactions, and{" "}
              <strong>IGST</strong> (Integrated GST — collected by the Central
              Government) for inter-state transactions.
            </p>
            <p>
              India has four primary GST slab rates: <strong>5%</strong> for
              essential goods, <strong>12%</strong> for standard goods,{" "}
              <strong>18%</strong> for most services and goods, and{" "}
              <strong>28%</strong> for luxury and demerit goods. Some essential
              items like unprocessed food and milk are exempt (0% GST).
            </p>
          </>
        }
        ...
        formulaContent={
          <>
            ...
            <ul>
              <li>
                <strong>Intra-state:</strong> CGST = GST/2, SGST = GST/2
              </li>
              <li>
        ...
        exampleContent={
          <>
            <p>
              <strong>Scenario:</strong> A product costs ₹10,000 (net price)
              with 18% GST, sold within the same state.
            </p>
            ...
            <p>
              For inter-state supply, the entire ₹1,800 would be collected as
              IGST instead of splitting into CGST and SGST.
            </p>
          </>
        }
        faqs={calc.faqs}
