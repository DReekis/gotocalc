...
const MortgageForm = dynamic(
  () => import("@/components/calculators/MortgageForm"),
    ...
    <>
      ...
      <CalculatorShell
        ...
        definitionContent={
          <>
            <p>
              A mortgage is a type of loan used to purchase real estate, where
              the property itself serves as collateral. The borrower agrees to
              pay back the loan, plus interest, over a set period (typically 15
              or 30 years) through regular monthly payments.
            </p>
            <p>
              Each monthly payment consists of two parts:{" "}
              <strong>principal</strong> (reducing the loan balance) and
              <strong> interest</strong> (the cost of borrowing). In the early
              years, a larger portion goes toward interest; as the loan matures,
              more goes toward principal. This is known as{" "}
              <strong>amortization</strong>.
            </p>
            <p>
              The <strong>down payment</strong> is the upfront amount paid by
              the buyer. A 20% down payment is standard and typically avoids the
              need for Private Mortgage Insurance (PMI). A larger down payment
              reduces both the monthly payment and total interest paid.
            </p>
          </>
        }
        ...
        formulaContent={
          <>
            <p>
              Monthly mortgage payments are calculated using the standard
            ...
            <ul>
              ...
              <li>
                <strong>P</strong> = Principal loan amount (home price minus
                down payment)
              </li>
              <li>
        ...
        exampleContent={
          <>
            <p>
              <strong>Scenario:</strong> Purchase a $400,000 home with 20% down
              at 6.5% interest over 30 years.
            </p>
            ...
            <ul>
              <li>
                <strong>Monthly Payment:</strong> $2,023
              </li>
              <li>
                <strong>Total Paid:</strong> $728,280 over 30 years
              </li>
              <li>
                <strong>Total Interest:</strong> $408,280
              </li>
            </ul>
          </>
        }
